...
class CreateMachineFromSnapshotJob implements ShouldQueue
{
     ...
     */
    public function __construct(int $user_id, string $name, int $plan_id, int $snapshot_id, $ssh_key_id, int $machine_id)
    {
    ...
    public function handle()
    {
        ...
        $result = $service->createMachineFromSnapshot(
            $this->machine_id,
            $this->name,
            $this->user_id,
            $this->plan_id,
