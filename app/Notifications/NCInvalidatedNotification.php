...
class NCInvalidatedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    private $user;
    private $profile;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('کاربر گرامی')
            ->line('کد ملی شما توسط کارشناسان ما بررسی شده و متاسفانه تایید نشده است.')
    ...
    {
        return [
            'message' => 'متاسفانه کد ملی شما مورد تایید قرار نگرفته است. دلیل: ' . $this->reason
        ];
    }
}
